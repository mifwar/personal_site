...
import profile from "@/assets/MiftahulAnwarCropped.jpg";
      ...
      <main className="bg-white dark:bg-gray-900">
        <section className="min-h-screen">
          <Navbar
            ...
            path="home"
          />
          <div className="relative rounded-full mx-auto w-48 h-48 overflow-auto mt-14 mb-10 bg-slate-200">
            <Image src={profile} alt="Miftahul Anwar" placeholder="blur" />
          </div>
          <div className="text-center">
            <h1 className="text-3xl dark:text-white font-Lato py-5">
              Hi, I am Miftahul Anwar
            </h1>
            <h2 className="text-md dark:text-white font-Poppins py-1">
